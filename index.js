...
function callfunc2(c, d, callback) {
  console.log(c - d);
  callback(function () {
    console.log("Inside the first nested callback");
    callback(function () {
      console.log("Inside the second nested callback");
      callback(function () {
        console.log("Inside the third nested callback");
        console.log("Hurray, deep callback hell!");
      });
    });
  });
}  

console.log("Before invoking callfunc2");
callfunc2(a, b, callfunc);
console.log("Hurray callbacks are working");
...
let p = new Promise((resolve, reject) => {
  ...
  // async data fetching in api

  async function getdata(){
    fetch('https://demo0260207.mockable.io/service1')
    .then((response)=>{
